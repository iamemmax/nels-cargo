    ...
    >
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-transparent to-primary-dark -z-10">
          <div className="flex flex-col justify-center gap-6  h-full w-full lg:w-[80%] px-[4rem] lg:px-[7.5rem] z-50 ">
            <div className="">
              <p className="font-header font-medium text-white text-base uppercase text-opacity-80">
                we are the best cargo & logistic company
              </p>
              <h1 className="font-header text-[2rem] mt-3 lg:text-[3.2rem] font-bold leading-normal lg:leading-[3.52rem] uppercase text-white">
                explore the world with our cargo services.
              </h1>
            </div>
            <div className="">
              <p className="font-body text-lg text-white w-full lg:w-[68%] text-opacity-80">
